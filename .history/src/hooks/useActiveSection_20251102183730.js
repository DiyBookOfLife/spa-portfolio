...
export default function useActiveSection(sectionIds) {
  ...
  useEffect(() => {
    ...
    // ✅ Handle mobile mode separately
    if (window.innerWidth <= 700) {
      // Simply set to empty so no section looks "active" when scrolling
      setActiveSection("");
      return; // skip observer logic entirely
    }
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        // Handle top and bottom edges precisely
